...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"  >
      <div class="container">
        <div class="navbar-header" >
          ...
          <div class="row">
            <a class="navbar-brand" href="index.php" col-md-3>Bookart</a>
            <form  method="post" action="search_book.php" class="col-md-6" style="margin-top:7px">
              <input type="text" class="form-control" id="inputPassword2" placeholder="Search Here" name="text">
    ...
    <?php
      if(isset($title) && $title == "Bookart") {
    ?>
    
    <div class="jumbotron"  style=" background: url('https://qw12.s3.amazonaws.com/bggla.png') no-repeat center center;background-size: cover;height:400px;" >
      <div class="container" style=" opacity:1;">
        <h1 style="text-align:center; margin:5% auto;font-family:didot; "><b><strong><marquee scrollamount="10">WELCOME TO THE BOOKART</b></strong></marquee></h1> 
        </br>
        </br>  
        <p style="text-align:center; margin:5% auto;"><strong><b>Here you can find your favourite books and order them online!</b></strong></p>     
      </div>
    </div>
    <?php } ?>
